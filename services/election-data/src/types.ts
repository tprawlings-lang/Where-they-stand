...
export const externalIdentifierKey = (identifier: ExternalIdentifierInput) => deterministicImportKey(identifier.authority,identifier.identifierType,identifier.externalId,["CANDIDATE_ID","BIOGUIDE_ID","STATE_PERSON_ID"].includes(identifier.identifierType)?"stable":identifier.electionCycle,identifier.validFrom?.toISOString(),identifier.validUntil?.toISOString());
